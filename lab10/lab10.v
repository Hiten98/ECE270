						...
						if(DIP[1:0] == 2'b00)
							begin
								case(state)
									...
									4'b0001: nextState = 4'b1101;
									4'b1101: nextState = 4'b0010;
									4'b0010: nextState = 4'b0011;
									4'b0011: nextState = 4'b0100;
									4'b0100: nextState = 4'b0101;
									4'b0101: nextState = 4'b1110;
									4'b1110: nextState = 4'b0110;
									4'b0110: nextState = 4'b1111;
								endcase
							end
						if(DIP[1:0] == 2'b01)
							begin
								case(state)
									4'b1111: nextState = 4'b0111;
									4'b0111: nextState = 4'b0001;
									4'b0001: nextState = 4'b1000;
									4'b1000: nextState = 4'b1001;
									4'b1001: nextState = 4'b0110;
									4'b0110: nextState = 4'b1111;
								endcase
							end
						if(DIP[1:0] == 2'b10)
							begin
								case(state)
									4'b1111: nextState = 4'b1010;
									4'b1010: nextState = 4'b0001;
									4'b0001: nextState = 4'b1000;
									4'b1000: nextState = 4'b1011;
									4'b1011: nextState = 4'b0110;
									4'b0110: nextState = 4'b0100;
									4'b0100: nextState = 4'b1101;
									4'b1101: nextState = 4'b1110;
									4'b1110: nextState = 4'b0010;
									4'b0010: nextState = 4'b1111;
								endcase
							end
						if(DIP[1:0] == 2'b11)
							begin
								case(state)
									4'b1111: nextState = 4'b0100;
									4'b0100: nextState = 4'b0110;
									4'b0110: nextState = 4'b1100;
									4'b1100: nextState = 4'b1011;
									4'b1011: nextState = 4'b1101;
									4'b1101: nextState = 4'b1010;
									4'b1010: nextState = 4'b1000;
									4'b1000: nextState = 4'b0000;
									4'b0000: nextState = 4'b1111;
								endcase
							end
					end
				case (nextState)
